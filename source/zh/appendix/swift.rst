...
本小节的源代码可以在 https://github.com/huan/tensorflow-handbook-swift/blob/master/src/ 找到。其中的 ``Mnist`` 数据集的辅助类的源代码文件为 ``mnist.swift`` ，需要单独加载。
...
.. code-block:: swift
    ...
    * https://github.com/huan/tensorflow-handbook-swift/blob/master/src/mnist.swift
    */
    let mnist = Mnist()
