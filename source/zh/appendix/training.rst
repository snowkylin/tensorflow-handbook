...
在以下的测试中，我们使用同一台主机上的4块NVIDIA GeForce GTX 1080 Ti显卡进行单机多卡的模型训练，训练所需的时间如下：

============  ========================  ========================
数据集         无MirroredStrategy        加入MirroredStrategy
============  ========================  ========================
cats_vs_dogs  146s/epoch                39s/epoch
tf_flowers    22s/epoch                 7s/epoch
============  ========================  ========================

可见，使用MirroredStrategy后，模型训练的速度有了大幅度的提高。
