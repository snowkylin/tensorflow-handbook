...
* 曾使用或正在使用TensorFlow 1.X版本或其他深度学习框架，希望了解TensorFlow 2.0新特性的开发者；
...
对于已有一定机器学习/深度学习基础，着重于模型建立与训练的学生和研究者，建议顺序阅读本书的2-6章。对于希望将TensorFlow模型部署到实际环境中的开发者和工程师，建议重点阅读本书的第7章。每章的开头提供了“前置知识”部分，方便读者查漏补缺。
