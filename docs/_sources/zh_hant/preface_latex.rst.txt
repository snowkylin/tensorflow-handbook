...
本手冊在2018年秋就已開始籌劃出版事宜，但由於 TensorFlow 版本迭代速度快，本手冊多次進行增訂的緣故，導致本手冊的出版時間一再推遲。在此手冊最終付梓時，TensorFlow 2.1 正式版已經發布，修正了 2.0 版本在使用中的諸多問題，使得 TensorFlow 2 的可用性和成熟度大爲加強，適合進行大規模的推廣普及。而本手冊經過多次修訂後，大部分內容也趨於穩定。因此，我認爲現在（2020年夏）是一個出版本手冊的成熟時機。儘管如此，本手冊依然可能存在着諸多缺陷、錯誤和過時之處。歡迎您在 https://discuss.tf.wiki 或圖靈社區反饋您在閱讀中遇到的問題。
